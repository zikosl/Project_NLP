...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(0, 0, 891, 511))
...
"background-color:\'#fff\'")
        ...
        self.plainTextEdit.setMinimumSize(QtCore.QSize(431, 291))
        self.plainTextEdit.setMaximumSize(QtCore.QSize(431, 291))
        font = QtGui.QFont()
